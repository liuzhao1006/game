...
#include "include/util/input_util.hpp"
#include "include/joystick-support.hpp"
#include "include/scene_manager.hpp"
#include "include/welcome_scene.hpp"
#include "include/native_engine.hpp"

// verbose debug logs on 1
...
void NativeEngine::GameLoop() {
    ...
    while (1) {
        ...
        while ((ALooper_pollAll(IsAnimating() ? 0 : -1, nullptr, &events, (void **) &source)) >=
               0) {
            if (source != nullptr) {
